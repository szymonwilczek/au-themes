...
;;; Commentary:
;;
;; Deep nocturnal basalt and native gold sanctuary with zero blue light hazard.
;; Part of the `au-themes' collection engineered for sensory-safe autistic and
...
(defconst au-aurum-night-palette-partial
  '(;; Canvas & Chrome
...
(defconst au-aurum-night-palette-mappings-partial
  '((err red)
...
(defconst au-aurum-night-palette
  (modus-themes-generate-palette
   au-aurum-night-palette-partial
   nil
   nil
   (append au-aurum-night-palette-mappings-partial ef-themes-palette-common)))
...
(provide 'au-aurum-night-theme)
;;; au-aurum-night-theme.el ends here
