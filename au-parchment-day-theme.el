;;; au-parchment-day-theme.el --- Authentic manuscript, vellum, and oak gall ink daytime theme -*- lexical-binding:t -*-
...
;; chroma entropy (Oklab C < 0.040) and typographic hierarchy. Part of the
