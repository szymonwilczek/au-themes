      ...
      (let* ((partial (cond
        ...
        (list
         ...
         :preprocessor (or (rainforest-get-theme-face-fg theme 'font-lock-preprocessor-face)
                           (cadr (assq 'yellow-cooler partial)) "#7a5028")
