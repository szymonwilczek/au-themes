...
(defconst rainforest-night-palette-partial
  '(;; Canvas: deep nocturnal forest humus under steady midnight rain
    ...
    (yellow "#8e4c1c")        ; Wet oak wood / fallen leaves: strings ("strings")
    ...
    (magenta "#a46eb0")       ; Deep heather plum: constants and macros (LOTA_PCR_COUNT, NULL)
    (magenta-warmer "#8cd0e4")
    (magenta-cooler "#b26e76") ; Wet cedar wood bark: builtins and attributes (__always_inline, :keywords)
...
(defconst rainforest-night-palette-mappings-partial
  '(;; Statuses
    ...
    (constant magenta)           ; #a46eb0 - Deep heather plum (LOTA_PCR_COUNT, NULL)
    (number yellow-warmer)       ; #c69038 - Wet amber resin (0, 24, 32 in buf[0])
    (builtin magenta-cooler)     ; #b26e76 - Wet cedar wood bark (__always_inline, :keywords)
...
(custom-theme-set-faces
 ...
 '(font-lock-constant-face ((t (:foreground "#a46eb0"))))
 '(font-lock-number-face ((t (:foreground "#bfa03c"))))
 '(font-lock-builtin-face ((t (:foreground "#b26e76"))))
